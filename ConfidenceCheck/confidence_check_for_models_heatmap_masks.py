# -*- coding: utf-8 -*-
"""
Created on Thu Jun  1 16:44:44 2023
...
if __name__ == '__main__':
    ...
    path_to_HMMask_dir = "D:/SLM/SLM_nowe/MASKI/" + model_name
    
    #method_list = ["AblationCAM/", "EigenGradCAM/", "GradCAM/", "GradCAM++/", "HiResCAM/", "ScoreCAM/", "GradientShap/", "IG/", "Occlusion_w30/", "Occlusion_w45/", "Saliency/"]
    #method = 'EigenGradCAM/' #'ScoreCAM/'
    method_list = ["Occlusion_w15/"]
    
    
    # path_to_HM = path_to_HM_dir + method + 'HM_255/' # 'pos/'
    # path_to_HMMask50 = path_to_HMMask_dir + method + "t_50/"
    # path_to_HMMask55 = path_to_HMMask_dir + method + "t_55/"
    # path_to_HMMask60 = path_to_HMMask_dir + method + "t_60/"
    # path_to_HMMask65 = path_to_HMMask_dir + method + "t_65/"
    
    # path_to_model = "D:/Testy_metod/nauczone_modele_kfold/resnet/model_resnet_TF6_k2.pt"
    # path_to_model = "D:/Testy_metod/nauczone_modele_kfold/densenet/model_densenet_TF5_k1.pt"
    # path_to_model = "D:/Testy_metod/nauczone_modele_kfold/mobilenet/model_mobilenet_TF5_k1.pt"
    # path_to_model = "D:/Testy_metod/nauczone_modele_kfold/squeezenet/model_squeezenet_TF2_k5.pt"
    # path_to_model = "D:/Testy_metod/nauczone_modele_kfold/googlenet/model_googlenet_TF6_k1.pt"
    # path_to_model = "D:/Testy_metod/nauczone_modele_kfold/alexnet/model_alexnet_TF6_k1.pt"
    # path_to_dataset = "D:/dataset_for_kfold5/k1"
    ...
    def evaluate_on_test_dataset(dataloaders, model):
...
#% WCZYTANIE DANYCH ZE ZBIORU TESTOWEGO
    ...
    labels_list, outputs_list  = evaluate_on_test_dataset(dataloaders, model)
    # print(labels_list)
    # print(outputs_list)
    # print(probs_list)
    #%%
    # prec = metrics.precision_score(labels_list, outputs_list, average='weighted')
    # acc = metrics.accuracy_score(labels_list, outputs_list)
    # f1 = metrics.f1_score(labels_list, outputs_list, average='weighted')
    # rec = metrics.recall_score(labels_list, outputs_list, average='weighted')
...
#     # jako różnicy między pewnocią starą a nową, 0 jeli pewnoć nie spadła lub wzrosła
    ...
    for method in method_list:
        print(method)
        path_to_HM = path_to_HMMask_dir + method + "t_50/"
        path_to_df = path_to_HM_dir + method[0:-1] + '_wyniki_zerowania_hmm_t50.csv'
        ...
        #en_oryginalna = tensors_to_list(en_oryginalna)
...
#%%    
    for method in method_list:
        print(method)
        path_to_HM = path_to_HMMask_dir + method + "t_55/"
        path_to_df = path_to_HM_dir + method[0:-1] + '_wyniki_zerowania_hmm_t55.csv'
...
#%%    
    for method in method_list:
        print(method)
        path_to_HM = path_to_HMMask_dir + method + "t_60/"
        path_to_df = path_to_HM_dir + method[0:-1] + '_wyniki_zerowania_hmm_t60.csv'
...
#%%    
    for method in method_list:
        print(method)
        path_to_HM = path_to_HMMask_dir + method + "t_65/"
        path_to_df = path_to_HM_dir + method[0:-1] + '_wyniki_zerowania_hmm_t65.csv'
...
#%%    
    for method in method_list:
        print(method)
        path_to_HM = path_to_HMMask_dir + method + "t_70/"
        path_to_df = path_to_HM_dir + method[0:-1] + '_wyniki_zerowania_hmm_t70.csv'
...
#%%    
    for method in method_list:
        print(method)
        path_to_HM = path_to_HMMask_dir + method + "t_75/"
        path_to_df = path_to_HM_dir + method[0:-1] + '_wyniki_zerowania_hmm_t75.csv'
...
#%%    
    for method in method_list:
        print(method)
        path_to_HM = path_to_HMMask_dir + method + "t_80/"
        path_to_df = path_to_HM_dir + method[0:-1] + '_wyniki_zerowania_hmm_t80.csv'
...
#%%    
    for method in method_list:
        print(method)
        path_to_HM = path_to_HMMask_dir + method + "t_85/"
        path_to_df = path_to_HM_dir + method[0:-1] + '_wyniki_zerowania_hmm_t85.csv'
...
#%%    
    for method in method_list:
        print(method)
        path_to_HM = path_to_HMMask_dir + method + "t_90/"
        path_to_df = path_to_HM_dir + method[0:-1] + '_wyniki_zerowania_hmm_t90.csv'
...
#%%    
    for method in method_list:
        print(method)
        path_to_HM = path_to_HMMask_dir + method + "t_95/"
        path_to_df = path_to_HM_dir + method[0:-1] + '_wyniki_zerowania_hmm_t95.csv'
